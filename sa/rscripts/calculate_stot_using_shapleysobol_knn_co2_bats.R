...
data_paths <- c(
  paste0(root_dir, "/QoI/bats/bats_annual_mean_pCO2surf.csv"),
  paste0(root_dir, "/QoI/bats/bats_annual_mean_CO2Flx.csv"),
  paste0(root_dir, "/QoI/bats/bats_annual_mean_EXPORTC.csv")
)

# Define paths for the output files
output_paths <- c(
  paste0(root_dir, "/indices/bats_stot_annual_mean_pCO2surf_knn.txt"),
  paste0(root_dir, "/indices/bats_stot_annual_mean_CO2Flx_knn.txt"),
  paste0(root_dir, "/indices/bats_stot_annual_mean_EXPORTC_knn.txt")
)
