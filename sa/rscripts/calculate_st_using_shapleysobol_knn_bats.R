...
write.table(si_mean_schl[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/bats_stot_annual_mean_schl_knn.txt")
...
write.table(si_mean_surf_nanochl[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/bats_stot_annual_mean_surf_nanochl_knn.txt")
...
write.table(si_mean_surf_diachl[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/bats_stot_annual_mean_surf_diachl_knn.txt")
...
write.table(si_max_schl[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/bats_stot_annual_max_schl_knn.txt")
...
write.table(si_max_surf_nanochl[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/bats_stot_annual_max_surf_nanochl_knn.txt")
...
write.table(si_max_surf_diachl[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/bats_stot_annual_max_surf_diachl_knn.txt")
...
write.table(si_mean_pCO2surf[["conf_int"]],'/scratch/usr/hbknama0/GSA/indices/bats_stot_annual_mean_pCO2surf_knn.txt')
...
write.table(si_mean_CO2Flx[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/bats_stot_annual_mean_CO2Flx_knn.txt")
...
write.table(si_mean_EXPORTC[["conf_int"]],'/scratch/usr/hbknama0/GSA/indices/bats_stot_annual_mean_EXPORTC_knn.txt')
