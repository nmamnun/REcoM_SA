...
data_paths <- c(
  paste0(root_dir, "/QoI/dyfamed/dyfamed_annual_mean_schl.csv"),
  paste0(root_dir, "/QoI/dyfamed/dyfamed_annual_mean_surf_nanochl.csv"),
  paste0(root_dir, "/QoI/dyfamed/dyfamed_annual_mean_surf_diachl.csv")
)

# Define paths for the output files
output_paths <- c(
  paste0(root_dir, "/indices/dyfamed_stot_annual_mean_schl_knn.txt"),
  paste0(root_dir, "/indices/dyfamed_stot_annual_mean_surf_nanochl_knn.txt"),
  paste0(root_dir, "/indices/dyfamed_stot_annual_mean_surf_diachl_knn.txt")
)
