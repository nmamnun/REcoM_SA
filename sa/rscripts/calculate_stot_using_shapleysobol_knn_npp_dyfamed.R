...
data_files <- c("/dyfamed_annual_mean_npp.csv", "/dyfamed_annual_mean_npp_nano.csv", "/dyfamed_annual_mean_npp_dia.csv")
output_files <- c("/dyfamed_stot_annual_mean_npp_knn.txt", "/dyfamed_stot_annual_mean_npp_nano_knn.txt", "/dyfamed_stot_annual_mean_npp_dia_knn.txt")
