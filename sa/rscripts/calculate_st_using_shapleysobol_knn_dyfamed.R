...
write.table(si_mean_npp[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/dyfamed_stot_annual_mean_npp_knn.txt")
...
write.table(si_mean_npp_nano[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/dyfamed_stot_annual_mean_npp_nano_knn.txt")
...
write.table(si_mean_npp_dia[["conf_int"]],"/scratch/usr/hbknama0/GSA/indices/dyfamed_stot_annual_mean_npp_dia_knn.txt")
