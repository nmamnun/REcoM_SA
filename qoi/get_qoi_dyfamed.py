...
sample_size = 100000
ncfile_dir = Path('/scratch/usr/hbknama0/GSA/model_outputs/dyfamed')
recomDiags3D_files = np.sort(list(ncfile_dir.glob('dyfamed_diags3d*')))
...
recomDiags2D_files = np.sort(list(ncfile_dir.glob('dyfamed_diags2d*')))
...
qoi_dir = Path('/scratch/usr/hbknama0/GSA/QoI/dyfamed')
write_csv(annual_max_surf_nanochl_df, os.path.join(qoi_dir, 'dyfamed_annual_max_surf_nanochl.csv'))
write_csv(annual_min_surf_nanochl_df, os.path.join(qoi_dir, 'dyfamed_annual_min_surf_nanochl.csv'))
write_csv(annual_mean_surf_nanochl_df, os.path.join(qoi_dir, 'dyfamed_annual_mean_surf_nanochl.csv'))

write_csv(annual_max_surf_diachl_df, os.path.join(qoi_dir, 'dyfamed_annual_max_surf_diachl.csv'))
write_csv(annual_min_surf_diachl_df, os.path.join(qoi_dir, 'dyfamed_annual_min_surf_diachl.csv'))
write_csv(annual_mean_surf_diachl_df, os.path.join(qoi_dir, 'dyfamed_annual_mean_surf_diachl.csv'))

write_csv(annual_max_schl_df, os.path.join(qoi_dir, 'dyfamed_annual_max_schl.csv'))
write_csv(annual_min_schl_df, os.path.join(qoi_dir, 'dyfamed_annual_min_schl.csv'))
write_csv(annual_mean_schl_df, os.path.join(qoi_dir, 'dyfamed_annual_mean_schl.csv'))

write_csv(annual_mean_npp_nano_df, os.path.join(qoi_dir, 'dyfamed_annual_mean_npp_nano.csv'))
write_csv(annual_mean_npp_dia_df, os.path.join(qoi_dir, 'dyfamed_annual_mean_npp_dia.csv'))
write_csv(annual_mean_npp_df, os.path.join(qoi_dir, 'dyfamed_annual_mean_npp.csv'))

write_csv(annual_mean_pCO2surf_df, os.path.join(qoi_dir, 'dyfamed_annual_mean_pCO2surf.csv'))
write_csv(annual_mean_CO2Flx_df, os.path.join(qoi_dir, 'dyfamed_annual_mean_CO2Flx.csv'))
write_csv(annual_mean_EXPORTC_df, os.path.join(qoi_dir, 'dyfamed_annual_mean_EXPORTC.csv'))
