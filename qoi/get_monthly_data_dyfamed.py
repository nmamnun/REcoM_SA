...
write_csv(monthly_mean_surf_nanochl_df, os.path.join(qoi_dir, 'dyfamed_monthly_mean_surf_nanochl.csv'))
write_csv(monthly_mean_surf_diachl_df, os.path.join(qoi_dir, 'dyfamed_monthly_mean_surf_diachl.csv'))
write_csv(monthly_mean_surf_chl_df, os.path.join(qoi_dir, 'dyfamed_monthly_mean_surf_chl.csv'))

write_csv(monthly_mean_npp_nano_df, os.path.join(qoi_dir, 'dyfamed_monthly_mean_npp_nano.csv'))
write_csv(monthly_mean_npp_dia_df, os.path.join(qoi_dir, 'dyfamed_monthly_mean_npp_dia.csv'))
write_csv(monthly_mean_npp_df, os.path.join(qoi_dir, 'dyfamed_monthly_mean_npp.csv'))

write_csv(monthly_mean_EXPORTC_df, os.path.join(qoi_dir, 'dyfamed_monthly_mean_EXPORTC.csv'))
write_csv(monthly_mean_CO2Flx_df, os.path.join(qoi_dir, 'dyfamed_monthly_mean_CO2Flx.csv'))
write_csv(monthly_mean_pCO2surf_df, os.path.join(qoi_dir, 'dyfamed_monthly_mean_pCO2surf.csv'))
